    ...
    <Layout>
        <section className="px-24 py-20">
            <header className="w-full flex flex-col items-center justify-center mb-10">
                ...
                <p className="text-xl font-medium w-3/4 text-center">Iro&apos;s born this month are passionate, motivated, and confident people who builds community with their cheerful disposition and relentless determination.</p>
            </header>
                ...
                <div className="w-[80%]">
                    ...
                    <ul className="space-y-6">
                        <li className="flex items-center">
                            ...
                            <span className="font-medium text-xl">Aries are attracted to people who can keep up with them.</span>
                        </li>
                        <li className="flex items-center">
                            <div className="bg-[#E849EB] p-2 rounded-full mr-3">
                                <Image src="/leo_w.svg" alt="leo logo" height={20} width={20}/>
                            </div>
                            <span className="font-medium text-xl">Creative Skills of Aries natives are heart winning.</span>
                        </li>
                        <li className="flex items-center">
                            <div className="bg-[#E849EB] p-2 rounded-full mr-3">
                                <Image src="/leo_w.svg" alt="leo logo" height={20} width={20}/>
                            </div>
                            <span className="font-medium text-xl">They are very Optimistic about everything.</span>
                        </li>
                    </ul>
                </div>
