...
const Header = () => {
	...
	return (
		<header className="max-w-[2000px] mx-auto fixed w-full top-0 bg-indigo-700 px-24 md:px-12 sm:px-5 py-5 lg:py-2 flex items-center justify-between z-30 shadow-sm shadow-indigo-900">
